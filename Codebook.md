...
- `tidy.txt`, which contains the data set.<br/>
- `Codebook.md`, the code book, which describes the contents of the data set (data, variables and transformations used to generate the data).<br/>
- `run_analysis.R`, the R script that was used to create the data set (see the [Creating the data set](#creating-data-set) section below)<br/> 
...
The `tidy.txt` file in this repository was created by running the `run_analysis.R` script using R version 3.4.1 (2017-12-19).
